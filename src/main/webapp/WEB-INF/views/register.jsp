...
<main class="container">
    <div class="register-container">
        ...
        <div class="social-login">
            <a href="https://accounts.google.com/o/oauth2/auth?..." class="social-btn google">
        ...
        <form action="<c:url value='/register'/>" method="post" id="register-form" novalidate>
            ...
            <div class="form-grid">
                <div class="form-group">
                    ...
                    <input type="text" id="fullName" name="fullName" class="form-control"
                           placeholder="Nhập họ và tên" required value="${oldFullName}">
                ...
                <div class="form-group">
                    ...
                    <input type="tel" id="phone" name="phone" class="form-control"
                           placeholder="Ví dụ: 0912345678" required value="${oldPhone}">
            ...
            <div class="form-grid">
                ...
                <div class="form-group password-group">
                    ...
                    <button type="button" class="btn-toggle-password"><i class="fa-solid fa-eye"></i></button>
                    <span id="confirm-error" class="error-msg"></span>
                </div>
            </div>
